...
"$PYTHON" -u evaluation/gen_eval/infer4eval.py \
  ...
  --outdir "$OUTDIR" \
  --enable_fastvar_compute_merge 0 --enable_spacevar_compute_merge 0 --enable_layerwise_cond_only_collapse 1 --cond_only_start_scale 36 --cond_only_start_layer 15
