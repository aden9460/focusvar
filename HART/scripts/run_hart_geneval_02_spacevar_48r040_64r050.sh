...
EXP_NAME="02_spacevar_48r040_64r050"
GPU_ID="3"
...
"$PYTHON" -u evaluation/gen_eval/infer4eval.py \
  ...
  --outdir "$OUTDIR" \
  --enable_fastvar_compute_merge 0 --enable_spacevar_compute_merge 1 --fastvar_ratio_by_scale 48:0.4,64:0.5 --fastvar_prune_scales 48,64 --fastvar_start_layer 0 --enable_layerwise_cond_only_collapse 0
