...
class FastVARAdaLNSelfAttn(nn.Module):
    ...
    def forward(
        ...
        if not self.disable_aln:
            ...
            is_later_layer = True
            x_hw = int(x.shape[1] ** 0.5)
            x_shape = (x.shape[0], x_hw, x_hw) if x_hw * x_hw == x.shape[1] else None
            ...
            if not self.shared_aln:
                ...
                if x_shape is not None and x.shape[1] in [self.cache_scale_step[0]*self.cache_scale_step[1]]:
